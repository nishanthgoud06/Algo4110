...
public class SortShow extends JPanel { 
		...
		public void SelectionSort(){
			...
			for(int i=0;i< lines_lengths.length;i++){
				int nextsmalletindex=getIndexOfSmallest(i,lines_lengths.length-1);
				swap(i,nextsmalletindex);
	...
	public void quick_sort(){
		Calendar start = Calendar.getInstance();
			quick(0,lines_lengths.length-1);
		Calendar end = Calendar.getInstance();
		//getting the time it took for the iterative merge sort to execute
		//subtracting the end time with the start time
	...
	public int sort_quick(int low,int high){
	...
	public void insertion_sort(){
		Calendar start = Calendar.getInstance();
		int length=lines_lengths.length;
